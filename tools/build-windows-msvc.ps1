...
param(
    ...
    [string]$RttRef = "feat/automatic-cyclic-io",
    [string]$Open62541Ref = "v1.4.15",
    [string]$Open62541ppRef = "v0.21.2",
    [string]$RttOpcuaRef = "feat/automatic-cyclic-io",
    [string]$HttplibRef = "6303872c8f419f6dda9b40bd3027c0116fdb3cc7",
    [string]$RttHttpRef = "feat/automatic-cyclic-io",
    [string]$OclRef = "feat/automatic-cyclic-io",
    [string]$UtilmmRef = "dev",
    [string]$TypelibRef = "dev",
    [string]$RttTypelibRef = "feat/automatic-cyclic-io",
    [string]$UtilrbRef = "master",
    [string]$MetarubyRef = "master",
    [string]$OrogenRef = "feat/automatic-cyclic-io",
